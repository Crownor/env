...
#=============================================================================
# spacevim-install.sh --- bootstrap script for SpaceVim
...
fetch_repo () {
    if [[ -d "$HOME/.SpaceVim" ]]; then
        ...
        git clone https://gitee.com/crownor/SpaceVim.git "$HOME/.SpaceVim"
        if [ $? -eq 0 ]; then
...
install_package_manager () {
    if [[ ! -d "$HOME/.cache/vimfiles/repos/github.com/Shougo/dein.vim" ]]; then
        ...
        git clone https://gitee.com/crownor/dein.vim.git $HOME/.cache/vimfiles/repos/github.com/Shougo/dein.vim
...
check_requirements () {
    ...
    bash -c "$(curl -fsSL https://gitee.com/crownor/dotfiles/raw/master/colors/24-bit-color.sh)"
}
# }}}
...
# download_font {{{
download_font () {
    url="https://gitee.com/crownor/env/resources/fonts/${1// /%20}"
